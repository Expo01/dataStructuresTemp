...
public class BinarySearchTree {
    ...
    private Node root; // root set to null. no constructor needed. this is handled in insert method where
    // if root == rull, then root = new value. insert is a factory meetehod which calls Node innerr class constructor
